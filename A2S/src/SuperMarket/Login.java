...
public class Login {
    ...
    {
        boolean result=true;
        String position=(userid.substring(3,4));
        
        if(userid.length()!=7)
        {
            JOptionPane.showMessageDialog(null,"Invalid user name.","Error",JOptionPane.ERROR_MESSAGE);
            result=false;
        }
        
        else if(!(userid.substring(0,3)).equalsIgnoreCase("MFD")){
           JOptionPane.showMessageDialog(null,"Invalid user name.","Error",JOptionPane.ERROR_MESSAGE);
            result=false;
        }
        
        else if((!position.equalsIgnoreCase("m"))&& (!position.equalsIgnoreCase("c")) && (!position.equalsIgnoreCase("a"))){
             JOptionPane.showMessageDialog(null,"Invalid user name.","Error",JOptionPane.ERROR_MESSAGE);
            result= false;
        }
